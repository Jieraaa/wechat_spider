CREATE TABLE `posts` (
  ...
  `biz` varchar(255) DEFAULT NULL COMMENT '每个账号的唯有标记base64',
  `appmsgid` varchar(255) DEFAULT NULL COMMENT '每个账号一个文章的 ID，注意，这里不是全局唯一的，多个账号可能重复',
  ...
  `digest` text,
  `idx` int(5) DEFAULT NULL COMMENT '多篇文章的时候的排序，第一篇是 1，第二篇是 2',
